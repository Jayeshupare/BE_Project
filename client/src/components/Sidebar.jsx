...
import { Eraser, FileText, Hash, House, Image, LogOut, Scissors, SquarePen, Users, Sparkles } from 'lucide-react';
...
const navItems = [
    ...
    { to: '/ai/generate-post', label: 'Post Creator', Icon: FileText },
    { to: '/ai/generate-prompt', label: 'Prompt Generator', Icon: Sparkles },

    { to: '/ai/summarize-text', label: 'Text Summarizer', Icon: FileText },
    // { to: '/ai/resume-builder', label: 'Resume Builder', Icon: FileText },
    { to: '/ai/check-plagiarism', label: 'Plagiarism Checker', Icon: Hash },
    { to: '/ai/generate-interview-questions', label: 'Interview Qs', Icon: Users },
    { to: '/ai/repurpose-content', label: 'Repurpose Engine', Icon: SquarePen },
